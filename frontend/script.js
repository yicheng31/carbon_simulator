...
const questions = [
  ...
  { id:3, category:"辦公", icon:"💻", sourceKey:"energy",
    ...
    options:[
      ...
      {label:"辦公室（冷氣全天）", icon:"🏢", kg:0.90, badge:"m", note:"0.90 kg CO₂e", src:"冷氣 1.4/hr × 8hr × 0.494", altLabel:"改為居家遠端"},
  ...
  { id:6, category:"空調", icon:"❄️", sourceKey:"energy",
    ...
    options:[
      ...
      {label:"26°C，搭配電扇", icon:"🌬️", kg:0.42, badge:"l", note:"0.42 kg CO₂e", src:"設定 26°C 省電 24%"},
      {label:"22°C，全日運轉", icon:"❄️", kg:2.77, badge:"m", note:"2.77 kg CO₂e", src:"22°C 4hr = 5.6 kgCO₂e（2人共用）", altLabel:"調高至 26°C＋電扇"},
